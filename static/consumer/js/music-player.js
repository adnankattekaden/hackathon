...
//     path: "./podcasters/audio2.mp3"
//   },
//   {
//     name: "Megan Thee",
//     artist: "Jessie J",
//     image: "images/dashboard/audio/01.png",
//     path: "./podcasters/audio1.mp3",
//   },
// ];
...
function loadTrack(music) {
  ...
  track_artist.textContent = music.fields.user;
...
$.ajax({
   ...
   success:function(data){
      ...
      console.log('next')
      console.log(music.fields.podcast)
      console.log(music.fields.thumbnail);
   }
